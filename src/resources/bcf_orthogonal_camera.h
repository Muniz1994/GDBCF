...
class BCFOrthogonalCamera : public Resource {
    GDCLASS(BCFOrthogonalCamera, Resource)

    Vector3 view_point;
    Vector3 direction;
    Vector3 up_vector;
    double  view_to_world_scale = 1.0;
...
public:
    ...
    void set_view_to_world_scale(double v)       { view_to_world_scale = v; }
    double get_view_to_world_scale() const       { return view_to_world_scale; }
